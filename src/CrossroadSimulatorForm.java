...
public class CrossroadSimulatorForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CrossroadSimulatorForm
     */
    public CrossroadSimulatorForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrossroadSimulatorForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrossroadSimulatorForm().setVisible(true);
            }
        });
    }
